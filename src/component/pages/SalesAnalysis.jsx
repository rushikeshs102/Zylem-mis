...
import UpDownArrawIcon from "../../icons/sync_alt_24dp_F19E39_FILL0_wght400_GRAD0_opsz24.svg";
...
function SalesAnalysis() {
    ...
    const getFilterTooltipContent = () => {
        if (selectedCriteria === "Select Filter") return "Filter";
        return (
            <Box>
                <Typography fontSize="14px" fontWeight="bold" display="flex" alignItems="center" justifyContent="center" >
                    Filter
    ...
    const renderValueField = () => {
        ...
        switch (selectedCriteria) {
            ...
            case 'City':
                // Show a proper input field by default, just like the initial state
                return (
                    <TextField
                        type="text"
                        variant="outlined"
            ...
            case 'Area':
                // Show a box with all areas when "Area" is clicked
                return (
                    <>
                        <Box sx={{
                            maxHeight: '200px',
                            ...
                            {areas.map((area, index) => (
                                <Box
                                    ...
                                    onClick={() => {
                                        ...
                                        setSelectedCriteria('City'); // Switch back to City after selection
                                    }}
                                >
        ...
        <>
            ...
            <Box sx={{ position: 'relative', height: "90%" }}>
                ...
                <div style={{ backgroundColor: '#F4F6F8' }} className={`flex flex-1 h-[90%] ${sideBarState ? "w-[100%]" : "w-[80%]"}`} >
                    ...
                    <div style={{ backgroundColor: '#F4F6F8' }} className="flex flex-1 w-[73%] h-[90%]">
                                ...
                                >
                                    ...
                                    <Droppable droppableId="controllers">
                                        {(provided) => (
                                            ...
                                            >
                                                <Typography sx={{ fontSize: "14px", paddingLeft: 1, paddingTop: 1 }} fontWeight="bold" >
                                                    Select controls
                                                </Typography>
                                                <TextField
                                                    placeholder="Search"
